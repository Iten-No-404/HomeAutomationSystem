...
#Write odb
write_design ${odb_dir}/home_system.odb

#write MXDB

write_mxdb ${mxdb_dir}/home_system.mxdb

#Write verilog
write_verilog ${output_dir}/verilog/home_system.syn.v

#Write SDC
write_sdc ${output_dir}/constraints/home_system.oasys.sdc

#save_upf
save_upf ${output_dir}/constraints/home_system.oasys.upf

#Write Floorplan (DEF)
write_def -floorplan ${output_dir}/floorplan/home_system.def
