...
group_path -name I2R -from [list [get_ports rst] [get_ports {st[0]}] [get_ports {st[1]}] [get_ports {st[2]}] [get_ports {st[3]}] [get_ports {st[4]}] [get_ports {st[5]}] [get_ports {st[6]}] [get_ports sfa] [get_ports sw] [get_ports srd] [get_ports sfd] [get_ports clk]]
group_path -name I2O -from [list [get_ports rst] [get_ports {st[0]}] [get_ports {st[1]}] [get_ports {st[2]}] [get_ports {st[3]}] [get_ports {st[4]}] [get_ports {st[5]}] [get_ports {st[6]}] [get_ports sfa] [get_ports sw] [get_ports srd] [get_ports sfd] [get_ports clk]]  -to [list [get_ports {display[0]}] [get_ports {display[1]}] [get_ports {display[2]}] [get_ports cooler] [get_ports heater] [get_ports alarmbuzz] [get_ports winbuzz] [get_ports rdoor] [get_ports fdoor]]
