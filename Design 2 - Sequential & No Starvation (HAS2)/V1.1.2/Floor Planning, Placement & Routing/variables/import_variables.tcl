...
##########################################################################################################################
set MGC_importVerilogNetlist "/home/vlsi/Desktop/Lab5/verilog/demo_myRippleAdder_withRegisters.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "HAS2"                     ; # REVIEW  : Name of top level module in verilog netlist(s).
